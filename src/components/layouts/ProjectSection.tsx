    ...
    >
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 relative z-10">
        {liveProjects.map((project) => (
          <Card
            key={project.id}
            className="group flex flex-col justify-between overflow-hidden border-border/60 bg-card/40 backdrop-blur-md transition-all duration-300 hover:-translate-y-1.5 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5"
          >
                ...
                <div className="rounded-xl border border-dashed border-border bg-muted/20 p-3 mt-4 flex items-start gap-2.5 transition-colors group-hover:bg-muted/40 group-hover:border-primary/20">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-muted-foreground leading-normal">
                      Review systemic architectural blueprints, structural
                      parameters, and ERD mockups natively inside the repos
                      below.
                    </p>
                  </div>
                </div>
